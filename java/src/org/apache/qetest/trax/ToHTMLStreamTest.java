...
public class ToHTMLStreamTest extends ToStreamTest
{
    ...
    public boolean testCase2() throws SAXException, IOException
    {
		...
		reporter.check(actual2, AELIG_OSLASH_ARING_NAMED_ENTITY, "ISO-8859-1 characters should come out as entities");
    	String actual2a = outputAttrValue(makeStream("ISO-8859-1"), AELIG_OSLASH_ARING);
		reporter.check(actual2a, AELIG_OSLASH_ARING_NAMED_ENTITY, "ISO-8859-1 characters should come out as entities (as attribute value)");
		...
		reporter.check(actual4, "&#65584;&curren;&#65586;", "Astral characters should come out as entities");
    	String actual4a = outputAttrValue(makeStream("ISO-8859-1"), utf16String);
		reporter.check(actual4a, "&#65584;&curren;&#65586;", "Astral characters should come out as entities (as attribute value)");
    ...
    public boolean testCase3() throws SAXException, IOException
    {
		...
		reporter.check(actual4c, "&#65584;&#164;&#65586;", "Astral characters should come out as entities (as attribute value)");
